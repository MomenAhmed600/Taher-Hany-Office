const translations = {
  ar: {
    ...
    "det-about-t": "القانون البحري والشحن",
    "det-about-d":
      "يقدم مكتب TAHER & HANY LAW FIRM خدمات قانونية متخصصة في قطاع النقل البحري والشحن، مع فهم عميق لطبيعة التجارة الدولية والتشريعات البحرية. نعمل على حماية مصالح عملائنا في مختلف مراحل عمليات النقل والتوريد، مع تقديم حلول قانونية فعالة تتناسب مع طبيعة النشاط البحري.",
  ...
  en: {
    ...
    "read-more": "Read More",
    "det-about-t": "Maritime Law and Shipping",
    "det-about-d":
      "TAHER & HANY LAW FIRM provides specialized legal services in the maritime transport and shipping sector, with a deep understanding of international trade and maritime legislation. We work to protect our clients' interests at every stage of the transport and supply chain, offering effective legal solutions tailored to the specific nature of maritime activity.",
